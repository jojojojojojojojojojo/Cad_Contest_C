...
void STR_add_to_stringtab_Int(void *hdl, const char *str, int inValue) {
    ...
    if (value != NULL)  {
        *value = inValue;
        ...
        // Ran out of memory
        defiError(1, 0, "Not enough memory");
    }
}
...
void init_symbol_table(void *Keyword_set)
{
    ...
    STR_add_to_stringtab_Int(Keyword_set, "COMPONENTMASKSHIFT", K_COMPSMASKSHIFT);
...
/*    STR_add_to_stringtab_Int(Keyword_set, "", K_END_SNETS) ; */
    ...
    STR_add_to_stringtab_Int(Keyword_set, "MASK", K_MASK) ;
    STR_add_to_stringtab_Int(Keyword_set, "MASKSHIFT", K_MASKSHIFT) ;
    ...
    STR_add_to_stringtab_Int(Keyword_set, "SAMEMASK", K_SAMEMASK);
    ...
    STR_add_to_stringtab_Int(Keyword_set, "VIRTUAL", K_VIRTUAL) ;
