...
void lefiDensity::addLayer(const char* name) {
  ...
  this->rects_[this->numLayers_] = 0;
  this->densityValue_[this->numLayers_] = 0;
  this->numLayers_ += 1;
}
...
void lefiDensity::addRect(double x1, double y1, double x2, double y2,
  ...
  this->rects_[this->numLayers_-1][this->numRects_[this->numLayers_-1]] = p;
  this->densityValue_[this->numLayers_-1][this->numRects_[this->numLayers_-1]] = value;
...
void lefiMacro::setFixedMask(int isFixedMask) {
    this->isFixedMask_ = isFixedMask;
}

int lefiMacro::isFixedMask() const {
    return this->isFixedMask_;
}
