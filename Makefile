...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = cada0411.0.0
DISTDIR = /home/josh/Desktop/CAD_Contest/Cad_Contest_C/objects/cada0411.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -L/home/josh/Desktop/CAD_Contest/Cad_Contest_C/lib/lefdef -llef -ldef -fopenmp -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
objects/placer_insure.o: src/placer/placer_insure.cpp src/placer/placer.h \
		src/circuit/circuit.h \
		src/circuit/layer.h \
		src/common/util.h \
		src/circuit/module.h \
		...
		src/parser/parser.h \
		src/placer/node.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o objects/placer_insure.o src/placer/placer_insure.cpp
